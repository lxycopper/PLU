...
_C.MODEL.ROI_HEADS.UDA_IOU_THRESHOLDS = [0.1,0.5]
_C.MODEL.ROI_HEADS.UDA_IOU_LABELS = [0, -1, 1]
_C.MODEL.ROI_HEADS.UDA_AUTO_LABELLING = False
_C.MODEL.ROI_HEADS.UDA_POS_FRACTION = 1
